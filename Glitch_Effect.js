...
var Glitch = function () {
    function Glitch(img) {
        ...
        // flow line
        for (var i = 0; i < 1; i++) {if (window.CP.shouldStopExecution(2)){break;}
            var o = {
                pixels: null,
...
window.CP.exitedLoop(2);
        ...
        // shift line
        for (var _i = 0; _i < 6; _i++) {if (window.CP.shouldStopExecution(3)){break;}
            var _o = null;
...
window.CP.exitedLoop(3);
        ...
        // shift RGB
        for (var _i2 = 0; _i2 < 1; _i2++) {if (window.CP.shouldStopExecution(4)){break;}
            var _o2 = null;
...
window.CP.exitedLoop(4);
        ...
        // scat imgs
        for (var _i3 = 0; _i3 < 3; _i3++) {if (window.CP.shouldStopExecution(5)){break;}
            var scatImg = {
                img: null,
                x: 0,
                y: 0
...
window.CP.exitedLoop(5);
    ...
    _createClass(Glitch, [{
        ...
        value: function replaceData(destImg, srcPixels) {
            for (var y = 0; y < destImg.height; y++) {if (window.CP.shouldStopExecution(7)){break;}
                for (var x = 0; x < destImg.width; x++) {if (window.CP.shouldStopExecution(6)){break;}
                    var r = void 0,
                        g = void 0,
                        b = void 0,
                        a = void 0;
...
window.CP.exitedLoop(7);
        ...
        value: function flowLine(srcImg, obj) {
            ...
            tempY = floor(obj.t1);
            for (var y = 0; y < srcImg.height; y++) {if (window.CP.shouldStopExecution(9)){break;}
                if (tempY === y) {
                    for (var x = 0; x < srcImg.width; x++) {if (window.CP.shouldStopExecution(8)){break;}
                        var r = void 0,
                            g = void 0,
                            b = void 0,
                            a = void 0;
...
window.CP.exitedLoop(9);
        ...
        value: function shiftLine(srcImg) {
            ...
            for (var y = 0; y < srcImg.height; y++) {if (window.CP.shouldStopExecution(11)){break;}
                if (y > rangeMin && y < rangeMax) {
                    for (var x = 0; x < srcImg.width; x++) {if (window.CP.shouldStopExecution(10)){break;}
                        var r = void 0,
                            g = void 0,
                            b = void 0,
                            a = void 0;
...
window.CP.exitedLoop(11);
        ...
        value: function shiftRGB(srcImg) {
            ...
            for (var y = 0; y < srcImg.height; y++) {if (window.CP.shouldStopExecution(13)){break;}
                for (var x = 0; x < srcImg.width; x++) {if (window.CP.shouldStopExecution(12)){break;}
                    var r = void 0,
                        g = void 0,
                        b = void 0,
                        a = void 0;
